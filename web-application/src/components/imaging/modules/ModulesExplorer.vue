  ...
  <v-card width="100%">
    ...
    <v-card-subtitle>
      <p class="subtitle-1 ml-1">
        Manage the modules created in Imaging. Rename them, hide them, and create
        new children.
      </p>
    </v-card-subtitle>
    <v-card-text>
                  ...
                  <template slot="label" slot-scope="{ item }">
                    <v-container
                      ...
                      ><v-row>
                        ...
                        <v-chip
                          small
                          :class="'mt-4 ml-3 ' + getModuleColor(item)"
                          text-color="white"
                        >
                          <v-avatar
                            left
                            :class="getModuleColor(item) + ' darken-4'"
                ...
                <v-scroll-y-transition mode="out-in">
                  ...
                  >
                    <v-row class="justify-center mb-4">
                      ...
                      <v-chip
                        :class="getModuleColor(selected)"
                        text-color="white"
                      >
                        <v-avatar
                          left
                          :class="getModuleColor(selected) + ' darken-4'"
                        >
                          {{ selected.level }}
                        </v-avatar>
                        Module
            ...
            <v-dialog v-model="dialog" persistent max-width="600px">
              <v-card>
                ...
                <v-card-actions>
                  ...
                  <v-btn color="blue darken-1" text @click="saveModule">
                    Save
                  </v-btn>
                </v-card-actions>
              </v-card>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async hideModule(level: ILevel) {
      // Pass
    },

    async unhideModule(level: ILevel) {
      // Pass
    },
