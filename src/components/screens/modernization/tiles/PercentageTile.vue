...
<script lang="ts">
import { StatisticsController } from "@/api/applications/StatisticsController";
import Vue from "vue";
...
export default Vue.extend({
  ...
  mounted() {
    ...
    } else if (this.displayedPercentage > 0.25 && this.displayedPercentage <= 0.5) {
      this.indicatorColor = "#f4a261";
    } else if (this.displayedPercentage > 0.5 && this.displayedPercentage <= 0.75) {
      this.indicatorColor = "#f4a261";
    } else {
