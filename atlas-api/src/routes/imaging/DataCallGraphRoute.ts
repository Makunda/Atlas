...
class DataCallGraphRoute implements Route {
    ...
    private initializeRoutes() {
        this.router.get(`${this.path}/number/masked/:application`,
            this.dataCallGraphController.getNumberMaskedDataGraph);

        this.router.get(`${this.path}/number/unmasked/:application`,
            this.dataCallGraphController.getNumberDataGraph);

        this.router.post(`${this.path}/batch/masked/:application`,
            this.dataCallGraphController.getBatchMaskedDataGraph);

        this.router.post(`${this.path}/batch/unmasked/:application`,
            this.dataCallGraphController.getBatchDataGraph);

        this.router.post(`${this.path}/mask/filter`,
            this.dataCallGraphController.maskDataGraphWithFilter);
        ...
        this.router.post(`${this.path}/mask/single`,
            this.dataCallGraphController.maskDataGraph);

        this.router.post(`${this.path}/unmask/single`,
            this.dataCallGraphController.unmaskDataGraph);

        this.router.post(`${this.path}/unmask/all`,
            this.dataCallGraphController.unmaskAllDataGraph);

        this.router.post(`${this.path}/mask/byCount`,
            this.dataCallGraphController.maskByObjectCount);

        this.router.post(`${this.path}/mask/byTerms`,
            this.dataCallGraphController.maskObjectByTerms);

        this.router.post(`${this.path}/mask/byTechnologies`,
            this.dataCallGraphController.maskByTechnologyCount);
