...
class ArtemisRoute implements Route {
  ...
  private initializeRoutes() {
    ...
    /** Artemis mode */
    this.router.get(`${this.path}/mode/online`, this.artemisController.getOnlineMode);
    this.router.get(`${this.path}/mode/repository`, this.artemisController.getRepositoryMode);

    this.router.post(`${this.path}/mode/online`, this.artemisController.setOnlineMode);
    this.router.post(`${this.path}/mode/repository`, this.artemisController.setRepositoryMode);
  }
}
