...
export default class LevelService {
   ...
   * @returns The label of the level  5
   */
  public static getLevel5Label(): string {
    return this.LEVEL_5_LABEL;
  }
  ...
  public async executeGroupingInAllApplications(): Promise<number> {
    ...
    try {
      ...
      logger.warn("Failed to execute the grouping operation on all applications.");
    }
  }
   ...
   */
  public async undoGroupedLevel5(applicationName: string, groupName: string): Promise<boolean> {
   ...
   * @param applicationName Name of the application
   */
  public async undoAllLevels(applicationName: string): Promise<boolean> {
   ...
   */
  public async renameLevel(applicationName: string, groupName: string, newName: string): Promise<boolean> {
