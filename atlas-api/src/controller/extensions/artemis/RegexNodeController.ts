...
import RegexNodesService from "@services/extensions/artemis/RegexNodesService";
...
class RegexNodeController {
  ...
  public getAllNodes = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public updateNode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const body: CreateRegexNodeDto = req.body;
      const results: RegexNode = await this.regexNodeService.updateRegexNode(body);
      res.status(200).json({ data: results, message: "Regex node" });
    } catch (error) {
      next(error);
    }
  ...
  public deleteNode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public testNode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const id = Number(req.params.id);
  ...
  public getRegexRequest = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const id = Number(req.params.id);
