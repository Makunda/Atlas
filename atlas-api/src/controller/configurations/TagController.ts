...
class TagController {
  ...
  public getFrameworkTag = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getLevelTag = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getModuleTag = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
