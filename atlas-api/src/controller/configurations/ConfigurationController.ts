...
class ConfigurationController {
  ...
  public getPythiaURI = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public setPythiaURI = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getPythiaTokenPresence = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getArtemisWorkspace = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public setArtemisWorkspace = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      res.status(HttpCode.INTERNAL_ERROR).json({ error: "Failed to set the Artemis workspace" });
    }
  };

  public getDemeterWorkspace = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      res.status(HttpCode.INTERNAL_ERROR).json({ error: "Failed to get the Demeter workspace" });
    }
  };

  public setDemeterWorkspace = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const workspace = String(req.body.workspace);
      if (!workspace || workspace.length == 0) {
        res.status(400).send({ data: null, message: "The workspace cannot be empty." });
  ...
  public getInternalMode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public setInternalMode = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
